...
const FooterNav = () => {
  return (
    <ul className="footer__list">
      <li className="footer__item"><FooterNavigation /></li>
      <li className="footer__item"><FooterNavigationYakitoria /></li>
      <li className="footer__item"><FooterNavigationDelivery /></li>
      <li className="footer__item"><FooterNavigationLegal /></li>
    </ul>
  );
};
